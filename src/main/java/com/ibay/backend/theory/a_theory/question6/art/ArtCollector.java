package com.ibay.backend.theory.a_theory.question6.art;
...
public class ArtCollector {
    ...
    @GetMapping
    List<Painting> getPaintings(@RequestParam Map<String, String> params) {
        return List.of();
    }
    ...
    @GetMapping(path = "{id}")
    Painting getPainting(@PathVariable("id") Integer id) {
        return new Painting();
    }
}
